...
def wishMe():
    ...
    speak(f"I am Jarvis your Personal Assistant. How may I help you?")
        ...
        # if 1:
            ...
            if "wikipedia" in query:
                ...
                try:
                    ...
                    speak("Sorry sir, due to network issue I am not able to find the location.")
                    pass
                ...
                speak("Okay sir, I am going to sleep now you can me anytime.")
                break
...
if __name__ == '__main__':
    ...
    names = ['', 'satyam']  # names, leave first empty bcz counter starts from 0
    ...
    while True:
        permission = takeCmd()
        if "wake up jarvis" in permission or "hello jarvis" in permission:
            TaskExecution()
